...
<div id="_header2">
    ...
    <div class="dropdown">
          <button class="dropbtn">Mom & Baby Care</button>
          <div class="dropdown-content">
                <div class="row">
                      <div class="column">
                            <h4>FACE</h4>
    ...
    <div class="dropdown">
          <button class="dropbtn">Hair Care</button>
          <div class="dropdown-content">
                <div class="row">
                      <div class="column">
                            <h4>Hare take</h4>
    ...
    <div class="dropdown">
          <button class="dropbtn">Gift & sets</button>
          <div class="dropdown-content">
                <div class="row">
                      <div class="column">
                            <h4>FACE</h4>
    ...
    <div id="_footer1">
      ...
      <div id="_a">
          <div id="pb">
              ...
              <button id="_btn"><a href="/DermStore/signup.html">SIGN ME UP</a></button>
          </div>
      </div> 
