function header() {
  return;
  `   <div id="_header1">
  <a href="index.html"> <img id="img"
   src="https://invitationdigital-res-1.cloudinary.com/image/upload/w_200,h_200,q_auto,fl_strip_profile,f_auto/dermstore_logo_1.jpg"
   alt=""></a>
   <form class="example" action="action_page.php">
       <input type="text" placeholder="Search for a Product or brand" name="search">
       <button type="submit"><i class="fa fa-search"></i></button>
   </form>
   <!-- <div id="_c_s"> -->
   <div id="_account">
       <img src="https://cdn.iconscout.com/icon/free/png-64/account-dashboard-man-person-profile-avatar-31698.png"
           alt="">
           <a href="#"><p> Account</p></a>
   </div>
   <div id="_count">
       <img src="https://cdn.iconscout.com/icon/free/png-64/cart-2188800-1844241.png" alt="">
   ...
   <div class="dropdown">
     ...
     <div class="dropdown-content">
       <div class="row">
         <div class="column">
           <h4>Concern</h4>
           <a href="BB_cream.html">BB CREAM </a>
           <a href="#">BLUSH</a>
           <a href="#">Bronzer </a>
           <a href="#">CC Cream </a>
           <a href="#">Contour </a>
   ...
   <div class="dropdown">
     ...
     <div class="dropdown-content">
       <div class="row">
         <div class="column">
           <h4>FACE</h4>
           <a href="dark_circles.html">Dark Circles </a>
  ...
  return `   <div id="_footer1">
    ...
    <div id="_b">
        <div id="p_i">
            <p>Connect with us</p>
            <div id="_img">
                <img src="https://cdn.iconscout.com/icon/free/png-64/facebook-1722382-1466168.png" alt="">
                <img src="https://cdn.iconscout.com/icon/free/png-64/twitter-1722376-1466162.png" alt="">
                <img src="https://cdn.iconscout.com/icon/free/png-64/instagram-logo-3605078-3004062.png" alt="">
                <img src="https://cdn.iconscout.com/icon/free/png-64/youtube-1722374-1466160.png" alt="">
                <img src="https://cdn.iconscout.com/icon/free/png-64/pinterest-1722378-1466164.png" alt="">
    ...
    <div id="_b3">
        ...
        <div id="_bbb1">
            ...
            <div id="_img2">
                ...
                <img src="https://cdn.iconscout.com/icon/free/png-64/visa-3-226460.png" alt="">
                <img src="https://cdn.iconscout.com/icon/free/png-64/visa-3-226460.png" alt="">
